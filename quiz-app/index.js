...
function renderNextQuestion() {
    ...
    $('.questions').html(allQuestionsHtml);
...
function nextQuestionController() {
    ...
    $('.questions').on('click', '.questionButton', function (event) {
        event.preventDefault();
        pageNumber++;
...
function summary() {
    ...
    $('.summary').show().html(message);
}

function reloadSite() {
    /* fancy javascript to reload page if user wants to play again */
    $('.summary').on('click', '.playAgainButton', function (event) {
        event.preventDefault();
